...
void drawBody(KJoint[] joints) {
  ...
  //println("elbowrihg : " +KinectPV2.JointType_ElbowRight);
  //println("shoulderright : " +KinectPV2.JointType_ShoulderRight);
  //println("wristright : " +KinectPV2.JointType_WristRight);
  //println("elbowleft : " +KinectPV2.JointType_ElbowLeft);
  //println("shouldertleft : " +KinectPV2.JointType_ShoulderLeft);
  //println("wristleft : " +KinectPV2.JointType_WristLeft);
  //shouldertleft 4
  //wristleft 6
  //elbowrihg 9
  //shoulderright 8
